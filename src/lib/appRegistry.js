...
export const appRegistry = {
  ...
  ddosSimulator: {
    ...
    isLocked: false,
    unlockRequirements: [],
    description: 'Visualize distributed denial of service attacks.',
  ...
  chemicalDatabase: {
    ...
    isLocked: false,
    unlockRequirements: [],
    description: 'Practice SQL queries on survival compounds.',
  ...
  radiationMonitor: {
    ...
    isLocked: false,
    unlockRequirements: [],
    description: 'Detect environmental radiation levels.',
  ...
  emergencyKeypad: {
    ...
    isLocked: false,
    unlockRequirements: [],
    description: 'Enter bunker access codes.',
